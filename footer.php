<footer>
	...
	<div class="row clearfix">
		...
		<div class="col-xs-4 hidden-xs">
			...
			<h4>
		    <a data-toggle="tooltip" data-placement="right" title="How to use this site" href="https://docs.google.com/a/umich.edu/document/d/1fKfcBDrZJA2Q3MpSOGfh6uFy2SxWqmP09vnNEJFFekg/edit?usp=sharing" target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i> Help Documents</a>
			</h4>
		</div>
